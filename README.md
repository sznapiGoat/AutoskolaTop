...
| `src/app/**` | Pages: `/`, `/sluzby` (overview + course process), `/sluzby/[slug]` (6 service subpages, statically generated), `/cenik`, `/caste-dotazy`, `/o-nas` (incl. `#pomahame`), `/kontakt`, `/ochrana-osobnich-udaju` |
